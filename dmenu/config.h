...
{
	"JetBrainsMono:style=Regular:pixelsize=24:antialias=true"
};
#endif // PANGO_PATCH
#if MANAGED_PATCH
...
char *colors[][2] = {
	/*               fg         bg       */
	[SchemeNorm] = { "#888888", "#151515" },
	[SchemeSel]  = { "#ffffff", "#9952e0" }, //5280e0
	[SchemeOut]  = { "#000000", "#9952e0" }, //9952e0 idk when this is used
	#if MORECOLOR_PATCH
