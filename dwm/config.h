...
static Key keys[] = {
	...
	// { 0,                     	    XF86XK_AudioLowerVolume, 	spawn, 			        SHCMD("pactl set-sink-volume 0 -3%; kill -45 $(pidof dwmblocks)") },
	// { 0,                       	    XF86XK_AudioMute, 			spawn, 			        SHCMD("pactl set-sink-mute 0 toggle; kill -45 $(pidof dwmblocks)") },
	// { 0,                       	    XF86XK_AudioRaiseVolume, 	spawn, 			        SHCMD("pactl set-sink-volume 0 +3%; kill -45 $(pidof dwmblocks)") },
	// INTERNET
	// { 0,							XF86XK_WLAN,				spawn,					SHCMD("kill -44 $(pidof dwmblocks)")	},
    // SCREEN
