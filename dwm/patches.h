 ...
 * https://dwm.suckless.org/patches/statuscmd/
 */
#define BAR_STATUSCMD_PATCH 1   // ATTENTION
 ...
 */
#define BAR_SYSTRAY_PATCH 0     // Want to remove, if dwmblocks works fine
 ...
 */
#define BAR_WINICON_PATCH 0     // Looks nice, but the stress to make it work and the astethic in the final result are probably not worth it
 ...
 */
#define BAR_HEIGHT_PATCH 1      // If I not mistaked, I use it because the icons in systray were trimmed
 ...
 */
#define BAR_PADDING_PATCH 0         // May be usefull for other systray methods
 ...
 * https://dwm.suckless.org/patches/statuscolors/
 */
#define BAR_STATUSCOLORS_PATCH 0        // Don't know if it's necessary for now
 ...
 */
#define ALWAYSCENTER_PATCH 0        // Maybeeeee
 ...
 */
#define CYCLELAYOUTS_PATCH 0                // Maybeee
 ...
 */
#define FAKEFULLSCREEN_PATCH 0      // Need to think about
 ...
 */
#define KEYMODES_PATCH 0        // Maybee
 ...
 */
#define NO_MOD_BUTTONS_PATCH 0      // Maybe
 ...
 */
#define ROUNDED_CORNERS_PATCH 1     // test
 ...
 */
#define SENDMON_KEEPFOCUS_PATCH 1       // Seems good
